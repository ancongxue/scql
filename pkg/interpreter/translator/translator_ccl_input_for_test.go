...
9 -> 10 [label = "t_14:{constant_data:PUBLIC:INT64}"]
	...
	{`select plain_int_0 from alice.tbl_0 into outfile party_code 'alice' '/tmp/output_alice.txt' party_code 'bob' '/tmp/output_bob.txt' fields terminated BY ','`, `digraph G {
0 [label="runsql:{in:[],out:[Out:{t_0,},],attr:[sql:select tbl_0.plain_int_0 from alice.tbl_0,table_refs:[alice.tbl_0],],party:[alice,]}"]
...
2 -> 3 [label = "t_2:{plain_int_0:PRIVATE:INT64}"]
	...
	{`select plain_int_0 from alice.tbl_0 into outfile party_code 'alice' '/tmp/output_alice.txt' party_code 'bob' '/tmp/output_bob.txt' party_code 'carol' '/tmp/output_carol.txt' columns terminated BY '|' optionally enclosed BY '"' lines terminated BY 'end of line';`, `digraph G {
0 [label="runsql:{in:[],out:[Out:{t_0,},],attr:[sql:select tbl_0.plain_int_0 from alice.tbl_0,table_refs:[alice.tbl_0],],party:[alice,]}"]
1 [label="dump_file:{in:[In:{t_0,},],out:[Out:{t_1,},],attr:[field_deliminator:|,file_path:/tmp/output_alice.txt,line_terminator:end of line,quoting_style:1,],party:[alice,]}"]
2 [label="copy:{in:[In:{t_0,},],out:[Out:{t_2,},],attr:[input_party_codes:alice,output_party_codes:bob,],party:[alice,bob,]}"]
3 [label="dump_file:{in:[In:{t_2,},],out:[Out:{t_3,},],attr:[field_deliminator:|,file_path:/tmp/output_bob.txt,line_terminator:end of line,quoting_style:1,],party:[bob,]}"]
4 [label="copy:{in:[In:{t_0,},],out:[Out:{t_4,},],attr:[input_party_codes:alice,output_party_codes:carol,],party:[alice,carol,]}"]
5 [label="dump_file:{in:[In:{t_4,},],out:[Out:{t_5,},],attr:[field_deliminator:|,file_path:/tmp/output_carol.txt,line_terminator:end of line,quoting_style:1,],party:[carol,]}"]
0 -> 1 [label = "t_0:{plain_int_0:PRIVATE:INT64}"]
0 -> 2 [label = "t_0:{plain_int_0:PRIVATE:INT64}"]
